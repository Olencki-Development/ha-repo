...
echo "\n\n"
DB_USERNAME="$CONFIG_DB_USERNAME" DB_PASSWORD="$CONFIG_DB_PASSWORD" DB_DATABASE="$CONFIG_DB_DATABSE" DB_HOST="$CONFIG_DB_HOST" BASIC_AUTH="$CONFIG_BASIC_AUTH_USERNAME:$CONFIG_BASIC_AUTH_PASSWORD" npm run dev
